...
import "./Habilidades2.css";
import "bootstrap/dist/css/bootstrap.min.css";

function Habilidades2() {
  return (
    <Container fluid className="Habilidades2_Container">
      <Container id="containerHabilidades2">
        <Row>
          <Col className="Habilidades2_Col_Codigo" sm={12} md={6} xl={6}>
          ...
          <Col
            className="ContainerInformacionHabilidades"
            sm={12}
            md={6}
            xl={6}
          >
            <h3 style={{ color: "white" }}>
              {" "}
              Desarrollo eficiente, seguro y profesional.
            </h3>
            <p>
              <br />
              Creamos para ti páginas web con diseños personalizados, de rápida
              carga, adaptables a dispositivos móviles y, enfocadas. <hr />
              Te ayudo a encaminar tu proyecto, posiciono tus productos o
              servicios en el mercado digital.
              <br />
              sin necesidad ser un amplio conocedor del marketing digital para
              contratar nuestro servicio. <br />
