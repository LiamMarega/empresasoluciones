    ...
    <Container fluid className='Habilidades2_Container'>
      <Container>
        <Row>
          <Col className='Habilidades2_Col_Codigo' sm={12} md={6} xl={6}>
            <div className='illustration-editor'>
              <div className='code-blocks'>
                <div className='code code-html'>
                  ...
                  <div className='code-content'>
                    <code>
                      <span className='c-r'>&lt;div</span> <span className='c-y'>class</span>
              ...
              <div className='code code-css'>
                ...
                <div className='code-content'>
                  <code>
                    ...
                    <br />
                    <p className='line-5'>
                      <span className='c-y'>$dark-gray</span> <span className='c-o'>100%</span>);{'}'}
                    </p>
                  </code>
                </div>
              </div>
              <div className='code code-js'>
                ...
                <div className='code-content'>
                  <code>
                    <span className='c-y'>var</span> <span className='c-b'>colors</span> = [<span className='c-g'>“#74B087”</span>, <span className='c-g'>“#DE7300”</span>, <span className='c-g'>“#74B087”</span>];
                    <br />
                    <br />
          ...
          <Col className='ContainerInformacionHabilidades' sm={12} md={6} xl={6}>
